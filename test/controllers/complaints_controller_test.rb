...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { block: @complaint.block, description: @complaint.description, floor: @complaint.floor, type: @complaint.type, user_id: @complaint.user_id } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { block: @complaint.block, description: @complaint.description, floor: @complaint.floor, type: @complaint.type, user_id: @complaint.user_id } }

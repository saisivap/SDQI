...
# Aminitebooking.create!([{user_id:1,roomsofaminite_id:1,aminite_id:1,from_time_day:"2020-4-20 10:00",to_time_day:"2020-4-20 12:00",date_of_day:"2020-4-20",vacate:0}])
# User.create!([{email:'saisiva@gmail.com',password:'sundaypsm',password_confirmation:'sundaypsm',admin:false,role:"security"}])
